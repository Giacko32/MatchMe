...
public class EmailSender {
    ...
    public static void sendNewAbbonamento(String codice, String email,String datadiscadenza){
        try {
            // Imposta le proprietà SMTP
            Properties properties = new Properties();
            properties.put("mail.smtp.host", "smtp.gmail.com");
            ...
            msg.setSubject("nonrisponderematchme@gmail.com");
            msg.setSentDate(new java.util.Date());
            msg.setText("Ciao, grazie per esserti abbonato, ecco il tuo codice con il quale potrai attivare l'abbonamento: "+codice+" ricorda che il tuo abbonamento scade in data: "+datadiscadenza);
            // Invia il messaggio email
            Transport.send(msg);
        } catch (MessagingException e) {
            e.printStackTrace();
